...
(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function pet_care_zone_customizer_label( id, title ) {
			...
			if ( id === 'animal_pet_shop_slider_setting' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-pet_care_zone_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'animal_pet_shop_service_setting' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-pet_care_zone_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'pet_care_zone_footer_text_setting' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-pet_care_zone_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
		...
		//Slider
		pet_care_zone_customizer_label( 'animal_pet_shop_slider_setting', 'Slider' );
		...
		//Our Services
		pet_care_zone_customizer_label( 'animal_pet_shop_service_setting', 'Our Services' );

		//Footer
		pet_care_zone_customizer_label( 'pet_care_zone_footer_text_setting', 'Footer' );
