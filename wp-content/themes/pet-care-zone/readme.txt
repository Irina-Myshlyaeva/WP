...
2. Type in Pet Care Zone in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Navigate to Appearance > Customize in your admin panel and customize to taste.

== Copyright ==

Pet Care Zone WordPress Theme, Copyright 2022 TheMagnifico52
Pet Care Zone is distributed under the terms of the GNU GPL
...
Pet Care Zone includes support for Infinite Scroll in Jetpack.

== Credits ==

Pet Care Zone bundles the following third-party resources:
...
Pxhere Images,
  ...
  Image, Copyright Q000024
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pxhere.com/en/photo/680856

  Image, Copyright Q000024
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/1029664

  Image, Copyright Q000024
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/714912

  Image, Copyright Q000024
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/265484
...
* Added classes for media in global color.
* Updated PHP version.
* Added minor CSS.
...
* Added web-font-file.
* Added social icons settings.
* Updated customizer settings.

= 3.7

* Updated tagline settings.
* Updated PHP version.
...
* Updated shop page settings.
* Product per page settings.
* Product row per page.
...
* Added Product loop on off setting.
