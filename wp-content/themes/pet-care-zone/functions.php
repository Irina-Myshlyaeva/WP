...
function pet_care_zone_custom_admin_notice() {
    ?>
    <div class="notice notice-success is-dismissible" style="background: #f7f9f9; padding: 20px 10px; display: flex;">
    	...
    	<div class="tm-admin-content" style="padding-left: 30px; align-self: center">
    		...
    		<h2 style="font-weight: 400;line-height: 1.3;color: #f15b26; margin: 0px;"><?php esc_html_e('Thank You For Choosing ', 'pet-care-zone'); ?><span class="blink_text" style="color: #4cc2c0;"><?php echo wp_get_theme(); ?></span><h2>
        	...
        	<a class="admin-notice-btn" style="font-size: 14px;font-weight: 400; min-height: 46px; line-height: 3.14285714; border-radius: 3px;padding: 15px 36px;background: #f15b26; color: #fff; text-decoration: none;" href="<?php echo esc_url( admin_url( 'themes.php?page=pet-care-zone-info.php' )); ?>"><?php esc_html_e( 'Get started', 'pet-care-zone' ) ?></a>
        	<a class="admin-notice-btn" style="margin-left: 10px;font-weight: 400; font-size: 14px; min-height: 46px; line-height: 3.14285714; border-radius: 3px;padding: 15px 36px;background: #f15b26; color: #fff; text-decoration: none;" target="_blank" href="<?php echo esc_url( PET_CARE_ZONE_PRO_DOC ); ?>"><?php esc_html_e( 'Documentation', 'pet-care-zone' ) ?></a>
...
add_action('admin_notices', 'pet_care_zone_custom_admin_notice');
